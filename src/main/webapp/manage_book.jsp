								...
								<tbody>
									<c:forEach items="${bookList}" var="book" varStatus="loop">
										<tr>
											...
											<td><a href="${pageContext.request.contextPath}/EditBook?id=${book.getId()}" class="btn btn-sm btn-info">Chỉnh sửa</a></td>
											<td><a href="DeleteBook?id=${book.id}" class="btn btn-sm btn-danger">Xóa</a></td>
										</tr>
